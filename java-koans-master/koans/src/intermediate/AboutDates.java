...
public class AboutDates {
    ...
    public void dateToString() {
        assertEquals(date.toString(), "Sat Mar 03 17:33:21 GMT+05:00 1973");
    }
    ...
    public void changingDateValue() {
        ...
        assertEquals(date.toString(), "Sat Mar 03 18:33:21 GMT+05:00 1973");
    }
    ...
    public void usingCalendarToChangeDates() {
        ...
        assertEquals(cal.getTime().toString(), "Tue Apr 03 18:33:21 GMT+05:00 1973");
    }
    ...
    public void usingRollToChangeDatesDoesntWrapOtherFields() {
        ...
        assertEquals(cal.getTime().toString(), "Sat Mar 03 18:33:21 GMT+05:00 1973");
    }
    ...
    public void usingDateFormatToParseDates() throws ParseException {
        ...
        assertEquals(date2.toString(), "Sat Jan 01 00:00:00 GMT+05:00 2000");
